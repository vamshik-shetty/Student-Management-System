...
(1, '1VE21CS012', 'STUDENT INSERTED', '2024-02-14 19:19:56'),
(2, '1VE21CS012', 'STUDENT UPDATED', '2024-02-14 19:20:31'),
(3, '1VE21CS012', 'STUDENT DELETED', '2024-02-14 19:21:23');
...
ALTER TABLE `student`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE INDEX `unique_rollno` (`rollno`);
